...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 \
                    ...
                    --pre-trained /cluster/work/cvl/guosun/shangye/pretrained/vim_s_midclstok_80p5acc.pth \
                    --batch-size 64  --drop-path 0.05  --lr 1e-3  \
                    --data-set INAT19 --weight-decay 0.05  --num_workers 32 --data-path ${TMPDIR}/datasets/  \
                    --output_dir /cluster/work/cvl/guosun/shangye/output/Vim_original/vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2_300e_batch_size128_inat \
                   --no_amp
