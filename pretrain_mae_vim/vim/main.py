...
from losses import DistillationLoss, MSELoss_dynamic
...
def main(args):
    ...
    #     {'params': decoder_params, 'lr': 3 * args.lr}
    # ]
    ...
    criterion = MSELoss_dynamic(
        criterion, mse_token=True, reconstruction_weight=1.0
    )
