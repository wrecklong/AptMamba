...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 \
                    ...
                    --teacher-path /cluster/work/cvl/guosun/shangye/output/Vim_original/vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2_300e_batch_size128_inat/checkpoint.pth \
                    --data-set INAT19  --distillation-type none --batch-size 128 --lr 0.00001 --min-lr 0.000001 --drop-path 0.0  \
                    --weight-decay 0.1  --num_workers 32 --data-path ${TMPDIR}/datasets/  \
                    --output_dir /cluster/work/cvl/guosun/shangye/output/Vim_new/vimpruning_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_clstok_div2_300einit_100e_batch_size128_p0.7_lr0.00001_min_lr1e-6_decoder_pruning_loss3stage_weight0.1_mse_weight0.02_sort_keep_policy_pretrain_mae_inat \
                   --base_rate 0.7  --mse_weight 0.02 --pruning_weight 0.1 --pretrained-mae-path /cluster/work/cvl/guosun/shangye/output/Vim_original/vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_clstok_div2_300e_batch_size128_mae_inat/checkpoint.pth \
