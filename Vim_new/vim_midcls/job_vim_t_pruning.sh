#!/bin/bash
#SBATCH -o /cluster/work/cvl/guosun/shangye/logs/vim_midcls/job.%j.out
#SBATCH -e /cluster/work/cvl/guosun/shangye/logs/vim_midcls/job.%j.err
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch \
		    ...
		    --output_dir /cluster/work/cvl/guosun/shangye/output/Vim_new/vimpruning_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2_300einit_100e_batch_size128_p0.7_lr0.00001_min_lr1e-6_pruning_loss3stage_weight0.05_distill_weight0_sort_keep_policy \
