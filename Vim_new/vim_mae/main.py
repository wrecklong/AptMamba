...
def get_args_parser():
    ...
    parser.add_argument('--pruning_weight', type=float, default='0')
...
def main(args):
    ...
    #optimizer = torch.optim.AdamW(other_parameters, lr = args.lr, eps = args.opt_eps, weight_decay=args.weight_decay) 
    #parameters = [
    #   {'params': other_params, 'lr': args.lr},
    #   {'params': decoder_params, 'lr':0, 'weight_decay':0}
    #]
